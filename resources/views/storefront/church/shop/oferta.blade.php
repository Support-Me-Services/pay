...
<style>
    ...
    .of-desc ul{ padding-left:1.2em; } .of-desc li{ margin:.3em 0; }
    .of-cta{ margin:40px auto 8px; max-width:820px; padding:0 24px; }
    .of-btn{ display:flex; align-items:center; justify-content:center; gap:10px; width:100%; padding:18px 28px; border-radius:16px; font-family:var(--lp-ui); font-size:18px; font-weight:700; color:#fff; background:linear-gradient(117deg, var(--lp-blue-a), var(--lp-blue-b)); box-shadow:0 12px 30px rgba(20,115,192,.28); transition:transform .15s ease, box-shadow .15s ease; }
