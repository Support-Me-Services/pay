        ...
        <div class="sp-container sp-doc sp-legal">
            <article class="sp-legal__body">
                <section class="sp-legal__section">
                    ...
                    <ol><li>Niniejszy regulamin określa zasady korzystania ze sklepu internetowego www.please-support-me.com w tym zasady zawierania umów sprzedaży, dostawy towarów, prawa do odstąpienia od umowy oraz trybu postępowania reklamacyjnego.</li><li>Sklep internetowy prowadzony jest przez Marcina Lulę prowadzącego działalność gospodarczą pn. Support Me Services Marcin Lula z siedzibą pod adresem w Pruszkowie przy ul. dr Izabeli Wolfram nr 11, 05-800 Pruszków, NIP: 8741624637 REGON: 341224327(„Sprzedawca”).</li><li>Kontakt ze Sprzedawcą jest możliwy za pośrednictwem poczty e-mail: <a href="mailto:office@please-support-me.com">office@please-support-me.com</a> w godzinach 8:00-20:00</li></ol>
                </section>
                <section class="sp-legal__section">
                    <h2>§ 2. Definicje</h2>
                ...
                <section class="sp-legal__section">
                    ...
                    <ol><li>Wszystkie ceny podane w Sklepie są cenami brutto (zawierają podatek VAT) i wyrażone są w polskich złotych (PLN).</li><li>Zgodnie z przepisami prawa, w przypadku ogłoszenia obniżki ceny (promocji), Sklep obok aktualnej ceny wyświetla najniższą cenę z 30 dni przed obniżką.</li><li>Sklep oferuje następujące metody płatności: płatność online lub płatności kartą.</li><li>Sklep realizuje dostawy na terytorium Polski za pośrednictwem firm kurierskich.</li><li>Czas realizacji zamówienia (skompletowanie i nadanie przesyłki) wynosi do 3 dni roboczych od zaksięgowania płatności; przewidywany czas doręczenia przez kuriera to kolejne 1–2 dni robocze.</li><li>Koszty dostawy są wyraźnie podane w procesie składania zamówienia i ponosi je Kupujący, chyba że wartość zamówienia przekracza kwotę uprawniającą do darmowej dostawy określoną w Sklepie.</li><li>Sprzedawca ponosi ryzyko uszkodzenia towaru w transporcie do momentu jego odbioru przez Kupującego.</li></ol>
                </section>
                <section class="sp-legal__section">
