<?php $__env->startSection('title', 'NFC Pay — sprzedawaj bez kasy i bez obsługi'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="section" id="kontakt">
        <div class="container" style="max-width:640px">
            ...
            <form method="POST" action="<?php echo e(route('lead.store')); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea id="message" name="message" rows="4" required><?php echo e(old('message')); ?></textarea>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pay/unified/resources/views/gateway/landing.blade.php ENDPATH**/ ?>